# Desarrollo Reto 4: Encapsulamiento y Polimorfismo aplicados
> Se presenta el desarrollo y la ejecución de lso ejercicios asigandos y el reto 4, demostrando un aterrizaje práctico de el polimorfismo
> y el encapsulamiento cómo conveción aplicados en python

A partir del presente se solucionan los siguientes ejercicios presentados
...
Donde se demuestra el uso del polimorfismo a partir del overrriding de métodos, junto con otros pilares fundamentales de la POO en escenarios de la cotidianidad
